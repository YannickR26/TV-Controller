...
public:
    ...
    QString getDateName()  	{ return QDate::longDayName(this->date.dayOfWeek());    		}
    int     getDateIndex()  { return this->date.dayOfWeek(); }//(date == "Monday" ? 0 : (date == "Tuesday" ? 1 : (date == "Wednesday" ? 2 : (date == "Thursday" ? 3 : (date == "Friday" ? 4 : (date == "Saturday" ? 5 : -1))))));    }
    QString getHour()       { return this->hour;    }
